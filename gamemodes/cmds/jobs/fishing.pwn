...
CMD:sellfish(playerid, params[])
{
	...
	new string[128];
	format(string,sizeof(string),"[Info]: {FFFFFF}Du hast dein gefangenes Fischgewicht von %d Kilo fùr $%d verkauft.",SpielerInfo[playerid][sFischGewicht],SpielerInfo[playerid][sFischGewicht] * 25);
...
CMD:angeln(playerid, params[])
{
 	...
 	if(IsPlayerInRangeOfPoint(playerid,2.0,403.8289,-2088.7974,7.8359))
  	{
        ...
        ApplyAnimation(playerid, "SAMP", "FishingIdle", 3.0,true,true,false,false,0);
   		SendClientMessage(playerid, COLOR_INFO, "[Info]: {FFFFFF}Benutze '/stopangeln' um mit dem Angeln aufzuhùren (Angel 1).");
    ...
    else if(IsPlayerInRangeOfPoint(playerid,2.0,398.7014,-2088.7983,7.8359))
    {
    	...
    	SetPlayerFacingAngle(playerid,180.2727);
     	SetCameraBehindPlayer(playerid);
      	ApplyAnimation(playerid, "SAMP", "FishingIdle", 3.0,true,true,false,false,0);
       	ApplyAnimation(playerid, "SAMP", "FishingIdle", 3.0,true,true,false,false,0);
   		SendClientMessage(playerid, COLOR_INFO, "[Info]: {FFFFFF}Benutze '/stopangeln' um mit dem Angeln aufzuhùren (Angel 2).");
   		FischTimer[playerid] = SetTimerEx("SpielerFischt",10000,true,"i",playerid);
   		return 1;
    }
    	...
    	SetPVarInt(playerid,"IstAmAngeln",1);
     	SetPlayerPos(playerid,396.1517,-2088.7983,7.8359);
      	SetPlayerFacingAngle(playerid,178.8467);
       	...
       	ApplyAnimation(playerid, "SAMP", "FishingIdle", 3.0,true,true,false,false,0);
        ApplyAnimation(playerid, "SAMP", "FishingIdle", 3.0,true,true,false,false,0);
   		SendClientMessage(playerid, COLOR_INFO, "[Info]: {FFFFFF}Benutze '/stopangeln' um mit dem Angeln aufzuhùren (Angel 3).");
   		FischTimer[playerid] = SetTimerEx("SpielerFischt",10000,true,"i",playerid);
   		return 1;
    }
    else if(IsPlayerInRangeOfPoint(playerid,2.0,391.0672,-2088.7976,7.8359))
    {
        ...
        ApplyAnimation(playerid, "SAMP", "FishingIdle", 3.0,true,true,false,false,0);
        ApplyAnimation(playerid, "SAMP", "FishingIdle", 3.0,true,true,false,false,0);
   		SendClientMessage(playerid, COLOR_INFO, "[Info]: {FFFFFF}Benutze '/stopangeln' um mit dem Angeln aufzuhùren (Angel 4).");
	   	FischTimer[playerid] = SetTimerEx("SpielerFischt",10000,true,"i",playerid);
  		return 1;
   	}
    	...
    	SetPVarInt(playerid,"IstAmAngeln",1);
     	SetPlayerPos(playerid,383.4083,-2088.7976,7.8359);
      	SetPlayerFacingAngle(playerid,180.2726);
       	...
       	ApplyAnimation(playerid, "SAMP", "FishingIdle", 3.0,true,true,false,false,0);
        ApplyAnimation(playerid, "SAMP", "FishingIdle", 3.0,true,true,false,false,0);
   		SendClientMessage(playerid, COLOR_INFO, "[Info]: {FFFFFF}Benutze '/stopangeln' um mit dem Angeln aufzuhùren (Angel 5).");
   		FischTimer[playerid] = SetTimerEx("SpielerFischt",10000,true,"i",playerid);
   		return 1;
    }
    else if(IsPlayerInRangeOfPoint(playerid,2.0,374.9251,-2088.7983,7.8359))
    {
        ...
        ApplyAnimation(playerid, "SAMP", "FishingIdle", 3.0,true,true,false,false,0);
        ApplyAnimation(playerid, "SAMP", "FishingIdle", 3.0,true,true,false,false,0);
   		SendClientMessage(playerid, COLOR_INFO, "[Info]: {FFFFFF}Benutze '/stopangeln' um mit dem Angeln aufzuhùren (Angel 6).");
   		FischTimer[playerid] = SetTimerEx("SpielerFischt",10000,true,"i",playerid);
   		return 1;
    }
    else if(IsPlayerInRangeOfPoint(playerid,2.0,369.8544,-2088.7983,7.8359))
    {
        ...
        ApplyAnimation(playerid, "SAMP", "FishingIdle", 3.0,true,true,false,false,0);
        ApplyAnimation(playerid, "SAMP", "FishingIdle", 3.0,true,true,false,false,0);
   		SendClientMessage(playerid, COLOR_INFO, "[Info]: {FFFFFF}Benutze '/stopangeln' um mit dem Angeln aufzuhùren (Angel 7).");
   		FischTimer[playerid] = SetTimerEx("SpielerFischt",10000,true,"i",playerid);
   		return 1;
    }
    else if(IsPlayerInRangeOfPoint(playerid,2.0,367.2825,-2088.7981,7.8359))
    {
        ...
        ApplyAnimation(playerid, "SAMP", "FishingIdle", 3.0,true,true,false,false,0);
        ApplyAnimation(playerid, "SAMP", "FishingIdle", 3.0,true,true,false,false,0);
   		SendClientMessage(playerid, COLOR_INFO, "[Info]: {FFFFFF}Benutze '/stopangeln' um mit dem Angeln aufzuhùren (Angel 8).");
   		FischTimer[playerid] = SetTimerEx("SpielerFischt",10000,true,"i",playerid);
   		return 1;
    }
    else if(IsPlayerInRangeOfPoint(playerid,2.0,362.1932,-2088.7983,7.8359))
    {
        ...
        ApplyAnimation(playerid, "SAMP", "FishingIdle", 3.0,true,true,false,false,0);
        ApplyAnimation(playerid, "SAMP", "FishingIdle", 3.0,true,true,false,false,0);
   		SendClientMessage(playerid, COLOR_INFO, "[Info]: {FFFFFF}Benutze '/stopangeln' um mit dem Angeln aufzuhùren (Angel 9).");
   		FischTimer[playerid] = SetTimerEx("SpielerFischt",10000,true,"i",playerid);
   		return 1;
    }
    else if(IsPlayerInRangeOfPoint(playerid,2.0,354.5322,-2088.7983,7.8359))
    {
        ...
        ApplyAnimation(playerid, "SAMP", "FishingIdle", 3.0,true,true,false,false,0);
        ApplyAnimation(playerid, "SAMP", "FishingIdle", 3.0,true,true,false,false,0);
   		SendClientMessage(playerid, COLOR_INFO, "[Info]: {FFFFFF}Benutze '/stopangeln' um mit dem Angeln aufzuhùren (Angel 10).");
   		FischTimer[playerid] = SetTimerEx("SpielerFischt",10000,true,"i",playerid);
   		return 1;
    }
