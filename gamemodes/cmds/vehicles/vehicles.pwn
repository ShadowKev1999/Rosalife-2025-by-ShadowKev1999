...
CMD:fahrzeug(playerid, params[])
{
	...
	ShowPlayerDialog(playerid,DIALOG_FAHRZEUG,DIALOG_STYLE_LIST,"{007DFF}"SERV_NAME"{FFFFFF} - Fahrzeugverwaltung",string,"Best�tigen","Abbrechen");
 	return 1;
}
...
CMD:motor(playerid, params[])
{
	...
	else if(Motor[tmpcar] == false)
	{
		...
		Motor[tmpcar] = true;
		if(GetPVarInt(playerid,"CopMaske") == 1){format(string,sizeof(string),"Unbekannter bet�tigt die Z�ndung.");}
		else if(GetPVarInt(playerid,"FraktionsMaske") == 1){format(string,sizeof(string),"Unbekannter bet�tigt die Z�ndung.");}
		else if(GetPVarInt(playerid,"GruppenMaske") == 1){format(string,sizeof(string),"Unbekannter bet�tigt die Z�ndung.");}
		else{format(string,128,"%s bet�tigt die Z�ndung.",SpielerInfo[playerid][sName]);}
		SetPlayerChatBubble(playerid, string, COLOR_PURPLE, 12.0, 3000);
		return 1;
	}
	return 1;
...
CMD:fenster(playerid, params[]) {
	...
	if(strfind(window, "Alle",true) != -1) {
	    ...
	    format(string,sizeof(string),"* %s hat alle Fenster vom Fahrzeug ge�ffnet.",SpielerInfo[playerid][sName]);
     	SendRoundMessage(x, y, z, COLOR_PURPLE, string);
	    ...
	    format(string,sizeof(string),"* %s hat das Vordere Fenster vom Fahrzeug ge�ffnet.",SpielerInfo[playerid][sName]);
     	SendRoundMessage(x, y, z, COLOR_PURPLE, string);
	    ...
	    format(string,sizeof(string),"* %s hat das Vordere Fenster Links vom Fahrzeug ge�ffnet.",SpielerInfo[playerid][sName]);
     	SendRoundMessage(x, y, z, COLOR_PURPLE, string);
	    ...
	    format(string,sizeof(string),"* %s hat das Vordere Fenster Rechts vom Fahrzeug ge�ffnet.",SpielerInfo[playerid][sName]);
     	SendRoundMessage(x, y, z, COLOR_PURPLE, string);
	    ...
	    format(string,sizeof(string),"* %s hat das Hintere Fenster vom Fahrzeug ge�ffnet.",SpielerInfo[playerid][sName]);
     	SendRoundMessage(x, y, z, COLOR_PURPLE, string);
	    ...
	    format(string,sizeof(string),"* %s hat das Hintere Fenster Links vom Fahrzeug ge�ffnet.",SpielerInfo[playerid][sName]);
     	SendRoundMessage(x, y, z, COLOR_PURPLE, string);
	    ...
	    format(string,sizeof(string),"* %s hat das Hintere Fenster Rechts vom Fahrzeug ge�ffnet.",SpielerInfo[playerid][sName]);
     	SendRoundMessage(x, y, z, COLOR_PURPLE, string);
...
CMD:givecarkey(playerid,params[])
{
	...
	new string[128];
	format(string,sizeof(string),"[Info]: {FFFFFF}Du hast %s einen Zweitschl�ssel zu deinem Fahrzeug gegeben.",SpielerInfo[pID][sName]);
	SendClientMessage(playerid,COLOR_SUPER,string);
	format(string,sizeof(string),"[Info]: {FFFFFF}%s hat dir einen Zweitschl�ssel f�r sein Fahrzeug gegeben.",SpielerInfo[playerid][sName]);
...
CMD:takecarkey(playerid,params[])
{
	...
	new string[128];
	format(string,sizeof(string),"[Info]: {FFFFFF}Du hast %s den Zweitschl�ssel zu deinem Fahrzeug weggenommen.",SpielerInfo[pID][sName]);
	SendClientMessage(playerid,COLOR_RED,string);
	format(string,sizeof(string),"[Info]: {FFFFFF}%s hat dir den Zweitschl�ssel f�r sein Fahrzeug weggenommen.",SpielerInfo[playerid][sName]);
